...
/**
 * @brief Configurations for audio and usb class
 *
 */
...
#define AUDIO_MCLK_SRC_I2S              0
#define AUDIO_MCLK_SRC_TIMER            1
...
/**
 * @brief Audio mode config
 *
 */
#define AUDIO_MODE                      AUDIO_MODE_SYNC
